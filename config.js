const nameGirl = 'chị em nhóm paylak';
const giftUrl = 'http://paylak.vn';
const eventName = 'Chúc Mừng 20-10';
const titleCard = 'Tặng người ấy';
const contentCard = 'Chúc các bạn nữ nhóm paylak 20/10 tràn ngập niềm vui và những nụ cười. Mong điều đẹp nhất sẽ đến với các bạn trong hôm nay và cả những ngày sau';
